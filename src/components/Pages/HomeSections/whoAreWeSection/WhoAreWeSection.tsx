				...
				<>
					<div className={style.whoAreWe__leftSection}>
						<div className={style.whoAreWe__leftSection__top}>
							<div
								className={
									style.whoAreWe__leftSection__top__title
								}
							>
								{currentLang["Who are we?"]}
							</div>
							<div
								className={
									style.whoAreWe__leftSection__top__description
								}
							>
								{
									currentLang[
						...
						<div className={style.whoAreWe__leftSection__bottom}>
							<div
								className={
									style.whoAreWe__leftSection__bottom__imgArea
								}
							>
								<Image
									className={
										style.whoAreWe__leftSection__bottom__imgArea__geometryImg
									}
									src={geometryImg}
									alt="Geometry Img"
								/>
							...
							<div
								className={
									style.whoAreWe__leftSection__bottom__paragraph
								}
							>
								<p>
									{
				...
				<>
					<div className={style.whoAreWe__leftSection}>
						<div className={style.whoAreWe__leftSection__top}>
							...
							<div
								className={
									style.whoAreWe__leftSection__top__middle
								}
							>
								<Image
									className={
										style.whoAreWe__leftSection__top__middle__img
									}
									src={whoAreWeImg}
									alt="Who Are We"
								/>
						...
						<div className={style.whoAreWe__leftSection__bottom}>
							...
							>
								{width > 576 ? (
									...
									<Image
										className={
											style.whoAreWe__leftSection__bottom__imgArea__geometryImg2
										}
										src={geometryImg2}
										alt="Geometry Img2"
									/>
